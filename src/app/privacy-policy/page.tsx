  ...
  return (
    <div className="flex justify-center py-12 px-4 pt-40">
      <div className="w-full md:w-3/5 lg:w-3/5 max-w-4xl">
        ...
        <p className="mb-4">
          {businessInfo.name} is committed to providing quality services to you and this policy
        ...
        <p className="mb-4">
          ...
          the Australian Information Commissioner at <a href="https://www.oaic.gov.au/" className="text-blue-600 hover:underline">https://www.oaic.gov.au/</a>.
        </p>
        
        <h2 className="text-2xl font-semibold mt-8 mb-4">What is Personal Information and why do we collect it?</h2>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">Sensitive Information</h2>
        ...
        <ul className="list-disc pl-8 mb-4">
          <li className="mb-2 text-left">For the primary purpose for which it was obtained</li>
          <li className="mb-2">For a secondary purpose that is directly related to the primary purpose</li>
        ...
        <ul className="list-disc pl-8 mb-4">
          <li className="mb-2">Third parties where you consent to the use or disclosure; and</li>
          <li className="mb-2">Where required or authorised by law.</li>
        </ul>
        
        <h2 className="text-2xl font-semibold mt-8 mb-4">Security of Personal Information</h2>
        ...
        <p className="mb-4">
          {businessInfo.name} will not charge any fee for your access request, but may charge an
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">Privacy Policy Complaints and Enquiries</h2>
        ...
        <address className="not-italic mb-8">
          ...
          <p><a href={`mailto:${businessInfo.email}`} className="text-blue-600 hover:underline">{businessInfo.email}</a></p>
          <p><a href={`tel:${businessInfo.phone.replace(/\s+/g, '')}`} className="text-blue-600 hover:underline">{businessInfo.phone}</a></p>
        </address>
      </div>
    </div>
  );
